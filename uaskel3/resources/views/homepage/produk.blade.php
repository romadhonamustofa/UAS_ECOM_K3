               ...
               <div class="row">
                  <div class="col-sm-5">
                     <div class="feature_box">
                        <h1 class="readable_text">Sepatu</h1>
                        <div><img src="{{asset('template/images/6.jpeg')}}" class="image_7"> </div>
                        <h2 class="readable_text">Rp. 300.000</h2>
                     </div>
                     <div class="feature_box_1">
                        <h1 class="readable_text">sepatu converse</h1>
                        <div><img src="{{asset('template/images/5.jpeg')}}" class="image_7"></div>
                        <h2 class="readable_text">Rp. 150.000</h2>
                     </div>
                  </div>
                  <div class="col-sm-7">
                     <div class="feature_box_2">
                        <h1 class="readable_text">baju polo</h1>
                        <div><img src="{{asset('template/images/4.jpeg')}}" class="image_8"></div>
                        
                        <h2 class="readable_text">Rp. 200.000</h2>
                     </div>
                  </div>
               </div>
               <div class="row">
                  <div class="col-sm-5">
                     <div class="feature_box">
                        <h1 class="readable_text">Baju set anak</h1>
                        <div><img src="{{asset('template/images/1.jpeg')}}" class="image_7"></div>
                        <h2 class="readable_text">Rp. 150.000</h2>
                     </div>
                     <div class="feature_box_1">
                        <h1 class="readable_text">Kaos</h1>
                        <div><img src="{{asset('template/images/2.jpeg')}}" class="image_7"></div>
                        <h2 class="readable_text">Rp. 300.000</h2>
                     </div>
                  </div>
                  <div class="col-sm-7">
                     <div class="feature_box_2">
                        <h1 class="readable_text">Kemeja</h1>
                        <div><img src="{{asset('template/images/3.jpeg')}}" class="image_8"></div>
