            ...
            <div class="row">
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section active">
                     <h1 class="bed_text">Celana katun</h1>
                     <div><img src="{{asset('template/images/9.jpeg')}}" class="image_2"></div>
                     
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     <h1 class="bed_text">Celana panjang</h1>
                     <div><img src="{{asset('template/images/8.jpeg')}}" class="image_2"></div>
                     
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     <h1 class="bed_text">Kemeja wanita</h1>
                     <div><img src="{{asset('template/images/7.jpeg')}}" class="image_2"></div>
                     
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     <h1 class="bed_text">sepatu ventela</h1>
                     <div><img src="{{asset('template/images/6.jpeg')}}" class="image_2"></div>
                    
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     <h1 class="bed_text">sepatu converse</h1>
                     <div><img src="{{asset('template/images/5.jpeg')}}" class="image_2"></div>
                     
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     <h1 class="bed_text">Kaos polo</h1>
                     <div><img src="{{asset('template/images/4.jpeg')}}" class="image_2"></div>
                     
                  </div>
               </div>
               <div class="col-lg-4 col-sm-12">
                  <div class="beds_section">
                     <h1 class="bed_text">Kemeja cowo</h1>
